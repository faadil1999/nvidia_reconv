    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        >
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                >
                    <div
                        class="flex lg:col-start-2 text-center lg:justify-center"
                    >
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a
                            :href="route('dashboard')"
                            id="docs-card"
                            class="flex flex-col col-span-full gap-6 overflow-hidden rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                        >
                            <div
                                ...
                                >
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <p class="mt-4 text-sm/relaxed">
                                            ...
                                            our professional transition app!
                                            Whether you’re seeking a fresh start
                                            or aiming to expand your skill set,
                                            our app guides you step-by-step
                                            toward a new career that aligns with
                                            your existing skills and experience.
                                            With personalized recommendations
                                            based on your career history,
                                            explore tailored training paths and
                                            build the expertise needed to
                                            succeed in an innovative field like
                                            web development. Join a community of
                                            evolving professionals and start
