const multiselectStyle = {
    ...
    tag: 'bg-theme-500 text-white text-sm font-semibold py-0.5 pl-2 rounded mr-1 mb-1 flex items-center rtl:pl-0 rtl:pr-2 rtl:mr-0 rtl:ml-1',
    ...
    dropdown:
        'max-h-60 absolute -left-px -right-px bottom-0 transform translate-y-full border border-zinc-300 -mt-px overflow-y-scroll z-50 bg-white flex flex-col rounded-b',
    ...
    groupLabelSelectedDisabled: 'text-theme-500/10 bg-theme-600 bg-opacity-50 cursor-not-allowed',
    groupOptions: 'p-0 m-0',
    option: 'flex items-center justify-start box-border text-left cursor-pointer text-base leading-snug py-2 px-3',
    optionPointed: 'text-theme-600 bg-theme-500/20 ',
    optionSelected: 'text-white bg-theme-500 font-semibold',
    optionDisabled: 'text-zinc-300 cursor-not-allowed',
    optionSelectedPointed: 'text-white bg-theme-600 font-semibold',
    optionSelectedDisabled: 'text-theme-500/10 bg-theme-500 bg-opacity-50 cursor-not-allowed',
